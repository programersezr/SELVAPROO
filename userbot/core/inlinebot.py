...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**Catuserbot"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/SU_SELVA"),
                )
            ]
            ...
            result = builder.article(
                title="Jmthon Help™",
                description="**▾∮ قائمة التعليمات الخاصة بــ سيلفا بروو **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/SU_SELVA"),
                Button.url(
                    "المطور",
                    "t.me/RR7PP",
                ),
        ...
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[ٍsoUrCe sElvA 🧸♥](https://t.me/SU_SELVA)",
