...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**قام مطورين السورس بتحديث سيلفا بروو**\n**التـغييرات\n** {changelog}"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "**-  تم تحديث سورس سيلفا بروو بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "**⌔∮ سورس سيلفا بروو محدث الى اخر اصدار **\n"
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond(f"⌔ : لتحديث سورس سيلفا بروو ارسل : `.تحديث الان` ")
    ...
    if conf == "الان":
        await event.edit("**• جار تحـديـث سـورس سيلفا بروو انـتـظـر قـليـلا 🔨**")
